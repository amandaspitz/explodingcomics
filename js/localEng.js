const imagesEng = [
  ...
  {
    issueNumber: 18,
    issueTitle: "Piece of cake",
    url: "0018.jpg",
    text: "Hey guys, how are you? You will notice that I am linking an old comic (number 18) for you today. The reason for that is that after rethinking the future scripts, I've decided that Garoa should't speak. So I am going to delete those two comics where she gets a dialogue and add a little more of the backstory of the romance. Plus, I was really happy to explore those panels and add more people in them. I am still not very good at it, but I can certainly see some proggress. For that to happen, we had to rethink the JS to add a  dropdown select button where you guys can navigate and also add the number to the hyperlink. The select is hopefully a temporary measure as I plan to have so many comics that will eventually be impossible to navigate through it. I am planning to have a little print run till december to gift my family and friends, but let's see the costs of that. I remember there were some options on the internet where people can order and print on demand, but I don't remember exactly how that works so I might get into that, as a few of you have mentioned you have the old issues of Exploding Comics, and would like to see a new one come to life. Well after 12 years of being a comic artist, I know for a fact that Exploding Comics is not my cash cow, so in everything I do here, I will try to put in as much love as possible, as I am not meeting deadlines or running against time. Comics aside, my life is as busy as it gets! Oh also my stove burned out, so we have been really creative with the eletric pan and the airfryer I have just bought a new one that is going to be installed Tuesday and I am so excited to cook in it!",
  },
  {
    issueNumber: 19,
    issueTitle: "Small talk",
    url: "0019.jpg",
    text: "Here I am, fashionably late with this week's comic! I had to work full-time over the weekend (Saturday AND Sunday!), so things got a bit wild. Anyway, here's the comic that's filling in the gap left by the ones where Garoa had her little chatty moments. Starting next week, a brand new arc begins, and we'll be back to publishing in order—yay! I had a bunch of things I wanted to ramble about in a blog post, but honestly... I'm drowning in work right now, so the good stuff will have to wait till next week. Catch you later!",
  },
  {
    issueNumber: 20,
    issueTitle: "Magical",
  ...
  {
    issueNumber: 35,
    issueTitle: "Sleeping Tight",
    url: "0035.jpg",
    text: "Exploding Comics is never late , it arrives precisely when it means to. It’s been over a year since I last showed up here, mainly because, throughout 2025, I was overwhelmed with work, doing around 12 hours a day, including weekends. It was a wonderful year, though. I managed to achieve many of the things I had been dreaming of for a long time, and it made me believe that all my effort, studying, and hard work really did pay off. Now I’m building the next step toward my life goals. And while I’ve been working like a mofo, I’ve said this before: every time I don’t publish here, I feel like a part of me is missing. So for 2026, one of my big goals was to play the piano more and draw for fun, not only for work. I have an amazing job and have been working with amazing people, feeling lucky every day. My job makes me so happy and excited to wake up every morning. And now I have free time to work on my hobbies as well. Now, regarding the comic: I used AI for this piece, and I feel like it might improve the quality and speed of my work here. I did the storyboard, sketch, entire lineart, and flat colors by hand. Then, when it was nearly done, I sent it to AI and asked it to emulate 2D hard shadows for me. After that, I downloaded the file and used it as a reference to color the shadows and adjust the details again by hand. I intend to keep the process as artisanal as possible, but I also want to make use of tools that can help me become a better artist. And reference is everything. Well, that’s it. Now off I go to my weekly DnD sesh. Catch ya soon.",
  },
];
